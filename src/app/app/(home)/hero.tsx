  ...
  <Container className="py-20 text-center lg:py-32">
    <h1 className="font-display mx-auto max-w-4xl text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
      ...
      <span className="relative whitespace-nowrap text-primary-600">
        ...
        <span className="relative">this easy</span>
      </span>
    </h1>
    <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      We know that setting up hosting, SEO and blog styling can be a cumbersome
      process. At Blogn you can skip all that and just focus on your content
    </p>
